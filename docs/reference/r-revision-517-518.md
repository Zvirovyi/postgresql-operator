...
* Timeline Management ([PR #629](https://github.com/canonical/postgresql-operator/pull/629)) ([DPE-5561](https://warthogs.atlassian.net/browse/DPE-5561))
* Add pgAudit ([PR #612](https://github.com/canonical/postgresql-operator/pull/612)) ([DPE-5248](https://warthogs.atlassian.net/browse/DPE-5248))
* postgresql.conf hardening ([PR #621](https://github.com/canonical/postgresql-operator/pull/621)) ([DPE-5512](https://warthogs.atlassian.net/browse/DPE-5512))
* Integrate with Tempo HA + relay tracing traffic through grafana-agent ([PR #640](https://github.com/canonical/postgresql-operator/pull/640))
* polish cos dashboard ([PR #646](https://github.com/canonical/postgresql-operator/pull/646))
* Update COS alert rules ([PR #651](https://github.com/canonical/postgresql-operator/pull/651)) ([DPE-5658](https://warthogs.atlassian.net/browse/DPE-5658))
* S3 Improvements ([PR #642](https://github.com/canonical/postgresql-operator/pull/642))
...
* Remove patching of private ops class. ([PR #617](https://github.com/canonical/postgresql-operator/pull/617))
* [MISC] Use more meaningful group naming for multi-group tests ([PR #625](https://github.com/canonical/postgresql-operator/pull/625))
* Ignore alias error in case alias is already existing ([PR #637](https://github.com/canonical/postgresql-operator/pull/637))
* Stop tracking channel for held snaps ([PR #638](https://github.com/canonical/postgresql-operator/pull/638))
* tf module on charm ([PR #643](https://github.com/canonical/postgresql-operator/pull/643))
* Add pgBackRest logrotate configuration ([PR #645](https://github.com/canonical/postgresql-operator/pull/645)) ([DPE-5601](https://warthogs.atlassian.net/browse/DPE-5601))
* Grants priviledges to non-public schemas ([PR #647](https://github.com/canonical/postgresql-operator/pull/647)) ([DPE-5387](https://warthogs.atlassian.net/browse/DPE-5387))
* add tls and tls-ca fields to databag ([PR #666](https://github.com/canonical/postgresql-operator/pull/666))
* Merge update_tls_flag into update_endpoints ([PR #669](https://github.com/canonical/postgresql-operator/pull/669))
* Quote tox.ini repository paths ([PR #678](https://github.com/canonical/postgresql-operator/pull/678)) ([DPE-6042](https://warthogs.atlassian.net/browse/DPE-6042))
* Add microceph (local backup) integration test + bump snap version ([PR #633](https://github.com/canonical/postgresql-operator/pull/633)) ([DPE-5386](https://warthogs.atlassian.net/browse/DPE-5386))

## Bugfixes and maintenance
* Add warning logs to Patroni reinitialisation ([PR #660](https://github.com/canonical/postgresql-operator/pull/660))

* Fix lib check ([PR #627](https://github.com/canonical/postgresql-operator/pull/627))
...
### Packaging
This charm is based on the Charmed PostgreSQL [snap Revision <TODO>]. It packages:
* [postgresql] `v.14.13`
* [pgbouncer] `v.1.21`
* [patroni] `v.3.1.2 `
* [pgBackRest] `v.2.53`
